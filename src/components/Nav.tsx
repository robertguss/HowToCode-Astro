...
export default function Nav() {
  return (
    <Popover className="relative bg-white" data-test="navigation">
      ...
      >
        <Popover.Panel
          focus
          className="mobile-menu absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden z-10"
        >
